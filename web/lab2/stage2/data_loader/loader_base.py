...
class DataLoaderBase(object):
    ...
    def load_cf(self, filename):
        ...
        file_path = os.path.join(current_dir, os.pardir, filename) #FIXME:路径有问题
    ...
    def load_kg(self, filename):
        ...
        #kg_data = pd.read_csv(file_path, sep=' ', names=['h', 'r', 't'], engine='python') #FIXME:python 参数？
        kg_data = pd.read_csv(file_path, sep=' ', names=['h', 'r', 't'] )
